...
function validatePasswordSome(rule, value) {
    ...
    <div class="password-box">
      ...
      <div class="password-box_content">
        ...
        >
          ...
          <n-form-item path="submitPassword">
            <n-input
              ref="rPasswordFormItemRef"
              v-model:value="formValue.submitPassword"
              placeholder="确认新密码"
              show-password-on="mousedown"
              maxlength="20"
              show-count
      ...
      <div class="password-box_footer">
        <n-button class="password-box_footer-btn" @click="handleCancel"
          >取消</n-button
        >
        <n-button
