...
let editUser = reactive({ ...user.value });
...
let validatPhone = computed(() => {
  return isPhone(editUser.phoneNumber);
});
let handleEdit = () => {
  isEdit.value = true;
};
      ...
      <div class="user-box_content">
        <div class="user-box_content-item">
          ...
          <div class="item-value user-avatar-box">
            ...
            <svg-icon v-else name="avatar" width="100" height="100"></svg-icon>
          </div>
          <img-cutter @getUrl="getUrl"></img-cutter>
        </div>
        <n-divider />
